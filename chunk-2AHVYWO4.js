import{b as ye,d as me}from"./chunk-EWXKBJTG.js";import{a as f,c as w}from"./chunk-5275NY2B.js";import{$c as I,Bb as Y,Cb as D,Da as T,Ia as j,Jd as le,Kc as te,Kd as ae,Lb as U,Lc as ie,Ld as de,Ma as Z,Mb as W,Na as z,Nb as E,Oa as C,Od as pe,Qd as he,Rc as ne,Rd as ce,Sd as u,T as M,Tc as oe,Uc as se,Vc as re,W as R,Wc as A,Xa as H,Y as O,Ya as F,Zb as k,_d as ve,a as d,aa as l,ac as y,ba as a,bb as p,cb as x,db as $,ha as s,ia as V,kb as L,la as B,lb as K,nb as b,nd as m,ob as r,pa as N,pb as Q,qb as S,rb as P,sb as q,tb as c,tc as G,ub as v,vc as J,wc as X,xc as ee,ya as h}from"./chunk-ROQKYTET.js";var ue=["content"],Ce=["overlay"],fe=["*","*"],xe=()=>({mode:null}),Oe=t=>({$implicit:t}),be=t=>({mode:t});function Ee(t,_){t&1&&L(0)}function we(t,_){if(t&1&&(S(0),C(1,Ee,1,0,"ng-container",3)),t&2){let e=r();h(),p("ngTemplateOutlet",e.contentTemplate||e._contentTemplate)("ngTemplateOutletContext",E(3,Oe,W(2,xe)))}}function Te(t,_){t&1&&L(0)}function Le(t,_){if(t&1){let e=K();x(0,"div",5,0),b("click",function(){l(e);let n=r(2);return a(n.onOverlayClick())}),x(2,"p-motion",6),b("onBeforeEnter",function(n){l(e);let o=r(2);return a(o.onOverlayBeforeEnter(n))})("onEnter",function(n){l(e);let o=r(2);return a(o.onOverlayEnter(n))})("onAfterEnter",function(n){l(e);let o=r(2);return a(o.onOverlayAfterEnter(n))})("onBeforeLeave",function(n){l(e);let o=r(2);return a(o.onOverlayBeforeLeave(n))})("onLeave",function(n){l(e);let o=r(2);return a(o.onOverlayLeave(n))})("onAfterLeave",function(n){l(e);let o=r(2);return a(o.onOverlayAfterLeave(n))}),x(3,"div",5,1),b("click",function(n){l(e);let o=r(2);return a(o.onOverlayContentClick(n))}),S(5,1),C(6,Te,1,0,"ng-container",3),$()()()}if(t&2){let e=r(2);Y(e.sx("root")),D(e.cn(e.cx("root"),e.styleClass)),p("pBind",e.ptm("root")),h(2),p("visible",e.visible)("appear",!0)("options",e.computedMotionOptions()),h(),D(e.cn(e.cx("content"),e.contentStyleClass)),p("pBind",e.ptm("content")),h(3),p("ngTemplateOutlet",e.contentTemplate||e._contentTemplate)("ngTemplateOutletContext",E(15,Oe,E(13,be,e.overlayMode)))}}function Se(t,_){if(t&1&&C(0,Le,7,17,"div",4),t&2){let e=r();p("ngIf",e.modalVisible)}}var De={root:()=>({position:"absolute",top:"0"})},ke=`
.p-overlay-modal {
    display: flex;
    align-items: center;
