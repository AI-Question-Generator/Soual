...
import { ProjectService, LessonService } from '@feature/projects/services';
import { SourceFileService } from '@feature/source-files/services';
import type { DomainChoice, DomainEnum, Project, ProjectDto } from '@feature/projects/models';
import type { SourceFileResponse } from '@feature/source-files/models';
