import{$a as T,$b as J,$d as ht,Ab as et,Bb as it,Bd as ct,Cb as b,Db as O,Dd as bt,Eb as j,Fb as rt,Hb as N,Hc as lt,Ib as z,Ic as st,Jc as ut,Ka as a,Kc as k,Ld as W,Mb as dt,O as I,Oc as K,P as B,Pb as h,Qb as $,R as _,Rb as V,Rd as pt,Sd as v,T as d,Vd as D,Xa as m,Xd as S,Ya as P,Yb as w,Yd as y,Za as A,Zd as c,_ as M,_d as gt,aa as Y,ab as p,bb as x,be as ft,ce as mt,da as F,hb as g,mc as f,na as s,pa as tt,pb as r,qb as R,rb as Q,rc as u,sb as E,sc as at,ta as nt,tb as G,ub as q,vb as Z,wb as L,xb as U,yb as ot}from"./chunk-4WTJBRVM.js";var vt=(()=>{class t extends y{autofocus=!1;focused=!1;platformId=d(nt);document=d(Y);host=d(tt);onAfterContentChecked(){this.autofocus===!1?this.host.nativeElement.removeAttribute("autofocus"):this.host.nativeElement.setAttribute("autofocus",!0),this.focused||this.autoFocus()}onAfterViewChecked(){this.focused||this.autoFocus()}autoFocus(){K(this.platformId)&&this.autofocus&&setTimeout(()=>{let n=mt.getFocusableElements(this.host?.nativeElement);n.length===0&&this.host.nativeElement.focus(),n.length>0&&n[0].focus(),this.focused=!0})}static \u0275fac=(()=>{let n;return function(o){return(n||(n=s(t)))(o||t)}})();static \u0275dir=A({type:t,selectors:[["","pAutoFocus",""]],inputs:{autofocus:[0,"pAutoFocus","autofocus"]},features:[p]})}return t})();var yt=`
    .p-badge {
        display: inline-flex;
