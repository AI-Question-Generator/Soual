import{a as et,b as Ct,c as v,d as nt,e as yt,f as Tt,g as wt,h as Et,i as St,j as kt,k as At,l as Lt,m as Nt,n as Bt,o as ot,p as Ft,q as It,r as Mt,s as Dt}from"./chunk-IQXVAIQ5.js";import{f as ht,g as vt,h as xt,i as _t}from"./chunk-LEMNYVEU.js";import{Ab as L,B as at,Ba as K,Da as ut,Ea as pt,Eb as X,F as E,Fa as mt,Hb as ft,I as s,Ia as M,Ib as bt,Ka as x,L as S,La as Q,Lb as Z,M as rt,Nb as _,O as $,Ob as tt,P as j,Q as k,Ra as U,S as B,Sa as Y,T as c,U as p,Ua as gt,V as dt,W as ct,X as m,Y as a,Z as u,_ as f,ea as F,fa as q,ha as A,ia as g,la as G,na as y,oa as T,p as O,q as V,r as lt,ra as I,s as R,t as b,ta as w,u as P,ua as d,ub as J,v as z,va as H,vb as D,y as N,zb as W}from"./chunk-WGCWW7QM.js";var Ot=`
    .p-togglebutton {
        display: inline-flex;
        cursor: pointer;
        user-select: none;
...
`;var Yt=["icon"],Jt=["content"],zt=e=>({$implicit:e});function Wt(e,i){e&1&&F(0)}function Xt(e,i){if(e&1&&f(0,"span",0),e&2){let t=g(3);w(t.cn(t.cx("icon"),t.checked?t.onIcon:t.offIcon,t.iconPos==="left"?t.cx("iconLeft"):t.cx("iconRight"))),m("pBind",t.ptm("icon"))}}function Zt(e,i){if(e&1&&c(0,Xt,1,3,"span",2),e&2){let t=g(2);p(t.onIcon||t.offIcon?0:-1)}}function te(e,i){e&1&&F(0)}function ee(e,i){if(e&1&&k(0,te,1,0,"ng-container",1),e&2){let t=g(2);m("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)("ngTemplateOutletContext",ut(2,zt,t.checked))}}function ne(e,i){if(e&1&&(c(0,Zt,1,1)(1,ee,1,4,"ng-container"),a(2,"span",0),d(3),u()),e&2){let t=g();p(t.iconTemplate?1:0),s(2),w(t.cx("label")),m("pBind",t.ptm("label")),s(),H(t.checked?t.hasOnLabel?t.onLabel:"\xA0":t.hasOffLabel?t.offLabel:"\xA0")}}var oe=`
    ${Ot}
...
`;var re=["item"],ue=(e,i)=>({$implicit:e,index:i});function se(e,i){return this.getOptionLabel(i)}function de(e,i){e&1&&F(0)}function ce(e,i){if(e&1&&k(0,de,1,0,"ng-container",3),e&2){let t=g(2),n=t.$implicit,o=t.$index,l=g();m("ngTemplateOutlet",l.itemTemplate||l._itemTemplate)("ngTemplateOutletContext",pt(2,ue,n,o))}}function pe(e,i){e&1&&k(0,ce,1,5,"ng-template",null,0,mt)}function me(e,i){if(e&1){let t=q();a(0,"p-togglebutton",2),A("onChange",function(o){let l=P(t),r=l.$implicit,h=l.$index,C=g();return z(C.onOptionSelect(o,r,h))}),c(1,pe,2,0),u()}if(e&2){let t=i.$implicit,n=g();m("autofocus",n.autofocus)("styleClass",n.styleClass)("ngModel",n.isSelected(t))("onLabel",n.getOptionLabel(t))("offLabel",n.getOptionLabel(t))("disabled",n.$disabled()||n.isOptionDisabled(t))("allowEmpty",n.getAllowEmpty())("size",n.size())("fluid",n.fluid())("pt",n.ptm("pcToggleButton"))("unstyled",n.unstyled()),s(),p(n.itemTemplate||n._itemTemplate?1:-1)}}var ge=`
    ${$t}
