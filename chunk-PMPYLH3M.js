import{Cb as h,Db as $,Eb as V,Ed as W,Ia as m,Ja as P,Ka as A,Kd as pt,Lb as w,Ld as v,Ma as T,Na as p,Oa as x,Ob as J,Od as D,Qd as S,Rd as y,Sd as c,T as I,Td as gt,U as B,Ua as g,Ud as ht,W as _,Wd as ft,Xd as mt,Y as d,ac as f,bb as r,ca as M,cb as R,db as Q,ea as Y,eb as E,fb as G,gb as q,gc as u,ha as F,hb as Z,hc as at,ib as L,jb as U,kb as ot,mb as et,nb as it,ob as b,pa as s,pb as O,qb as j,ra as tt,rb as rt,ta as nt,tb as N,tc as lt,td as ct,ub as z,uc as st,vc as ut,vd as bt,wc as k,xc as K,ya as a,zb as dt}from"./chunk-ROQKYTET.js";var vt=(()=>{class t extends y{autofocus=!1;focused=!1;platformId=d(nt);document=d(Y);host=d(tt);onAfterContentChecked(){this.autofocus===!1?this.host.nativeElement.removeAttribute("autofocus"):this.host.nativeElement.setAttribute("autofocus",!0),this.focused||this.autoFocus()}onAfterViewChecked(){this.focused||this.autoFocus()}autoFocus(){K(this.platformId)&&this.autofocus&&setTimeout(()=>{let n=mt.getFocusableElements(this.host?.nativeElement);n.length===0&&this.host.nativeElement.focus(),n.length>0&&n[0].focus(),this.focused=!0})}static \u0275fac=(()=>{let n;return function(o){return(n||(n=s(t)))(o||t)}})();static \u0275dir=A({type:t,selectors:[["","pAutoFocus",""]],inputs:{autofocus:[0,"pAutoFocus","autofocus"]},features:[p]})}return t})();var yt=`
    .p-badge {
        display: inline-flex;
